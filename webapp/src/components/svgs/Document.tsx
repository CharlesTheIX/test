...
const Document: React.FC<Props> = (props: Props) => {
  ...
  return (
    <svg fill={"none"} width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 12H9M16 12H12" stroke={primary_color} strokeWidth={1.5} strokeLinecap="round" />
      <path d="M16 8H15M12 8H8" stroke={primary_color} strokeWidth={1.5} strokeLinecap="round" />
      <path d="M8 16H13" stroke={primary_color} strokeWidth={1.5} strokeLinecap="round" />
      <path
        strokeWidth={1.5}
